...
def game(max_move_n=225, timeout=3, timeinit=5):
    white = BackendAgent('python3 for_competition_delete_later.py', 'White')
    black = BackendAgent('python3 for_competition_delete_later.py', 'Black')
